...
extension GetGeneralTagCollection on Isar {
  IsarCollection<GeneralTag> get generalTags => this.collection();
}

const GeneralTagSchema = CollectionSchema(
  name: r'GeneralTag',
  ...
  estimateSize: _generalTagEstimateSize,
  serialize: _generalTagSerialize,
  deserialize: _generalTagDeserialize,
  deserializeProp: _generalTagDeserializeProp,
  idName: r'id',
  indexes: {},
  links: {},
  embeddedSchemas: {},
  getId: _generalTagGetId,
  getLinks: _generalTagGetLinks,
  attach: _generalTagAttach,
  version: '3.1.0+1',
);

int _generalTagEstimateSize(
  GeneralTag object,
  List<int> offsets,
...
P _generalTagDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
Id _generalTagGetId(GeneralTag object) {
  return object.id;
}

List<IsarLinkBase<dynamic>> _generalTagGetLinks(GeneralTag object) {
  return [];
}

void _generalTagAttach(IsarCollection<dynamic> col, Id id, GeneralTag object) {
  object.id = id;
}

extension GeneralTagQueryWhereSort
    on QueryBuilder<GeneralTag, GeneralTag, QWhere> {
  QueryBuilder<GeneralTag, GeneralTag, QAfterWhere> anyId() {
...
extension GeneralTagQueryWhere
    on QueryBuilder<GeneralTag, GeneralTag, QWhereClause> {
  QueryBuilder<GeneralTag, GeneralTag, QAfterWhereClause> idEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<GeneralTag, GeneralTag, QAfterWhereClause> idNotEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<GeneralTag, GeneralTag, QAfterWhereClause> idGreaterThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<GeneralTag, GeneralTag, QAfterWhereClause> idLessThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<GeneralTag, GeneralTag, QAfterWhereClause> idBetween(
    Id lowerId,
    Id upperId, {
...
extension GeneralTagQueryFilter
  ...
  QueryBuilder<GeneralTag, GeneralTag, QAfterFilterCondition> idGreaterThan(
    Id value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<GeneralTag, GeneralTag, QAfterFilterCondition> idLessThan(
    Id value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<GeneralTag, GeneralTag, QAfterFilterCondition> idBetween(
    Id lower,
    Id upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension GeneralTagQueryObject
    on QueryBuilder<GeneralTag, GeneralTag, QFilterCondition> {}

extension GeneralTagQueryLinks
    on QueryBuilder<GeneralTag, GeneralTag, QFilterCondition> {}
...
extension GeneralTagQuerySortThenBy
  ...
  QueryBuilder<GeneralTag, GeneralTag, QAfterSortBy> thenByIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension GeneralTagQueryProperty
    on QueryBuilder<GeneralTag, GeneralTag, QQueryProperty> {
